...
export declare namespace apphub_v1alpha {
    ...
    export class Resource$Projects$Locations$Discoveredservices {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        lookup(params: Params$Resource$Projects$Locations$Discoveredservices$Lookup, options: StreamMethodOptions): GaxiosPromise<Readable>;
        lookup(params?: Params$Resource$Projects$Locations$Discoveredservices$Lookup, options?: MethodOptions): GaxiosPromise<Schema$LookupDiscoveredServiceResponse>;
    ...
    export class Resource$Projects$Locations$Discoveredworkloads {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        lookup(params: Params$Resource$Projects$Locations$Discoveredworkloads$Lookup, options: StreamMethodOptions): GaxiosPromise<Readable>;
        lookup(params?: Params$Resource$Projects$Locations$Discoveredworkloads$Lookup, options?: MethodOptions): GaxiosPromise<Schema$LookupDiscoveredWorkloadResponse>;
