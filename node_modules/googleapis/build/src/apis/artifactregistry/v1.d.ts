...
export declare namespace artifactregistry_v1 {
    ...
    export class Resource$Media {
        ...
        download(params?: Params$Resource$Media$Download, options?: MethodOptions): GaxiosPromise<Schema$DownloadFileResponse>;
        ...
        download(params: Params$Resource$Media$Download, options: MethodOptions | BodyResponseCallback<Schema$DownloadFileResponse>, callback: BodyResponseCallback<Schema$DownloadFileResponse>): void;
        download(params: Params$Resource$Media$Download, callback: BodyResponseCallback<Schema$DownloadFileResponse>): void;
