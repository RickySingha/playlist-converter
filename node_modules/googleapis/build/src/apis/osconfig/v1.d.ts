...
export declare namespace osconfig_v1 {
    ...
    export class Resource$Projects$Locations$Global {
         ...
         */
        getProjectFeatureSettings(params: Params$Resource$Projects$Locations$Global$Getprojectfeaturesettings, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getProjectFeatureSettings(params?: Params$Resource$Projects$Locations$Global$Getprojectfeaturesettings, options?: MethodOptions): GaxiosPromise<Schema$ProjectFeatureSettings>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        updateProjectFeatureSettings(params: Params$Resource$Projects$Locations$Global$Updateprojectfeaturesettings, options: StreamMethodOptions): GaxiosPromise<Readable>;
        updateProjectFeatureSettings(params?: Params$Resource$Projects$Locations$Global$Updateprojectfeaturesettings, options?: MethodOptions): GaxiosPromise<Schema$ProjectFeatureSettings>;
